...
export default function BannerSection () {
    return(
        <div className='w-full bg-green-100 flex-col space-y-4 justify-center overflow-hidden h-44' id='employerBanner'>
            <div className='w-full flex flex-col justify-center h-44' style={{background: "rgba(0,0,0,.5)"}}>
                <div className='flex flex-col space-y-2 items-center justify-center text-white'>
                    <h1 className='xl:text-3xl text-2xl font-bold capitalize'>employers</h1>
